...
- (void)showAdvertisement {
    ...
    NSLog(@"Initial Run:%@", [defaults objectForKey:@"Initial Run"]);
    
    // if ad shown today then don't show
    
    // Remove the preference
    [defaults removeObjectForKey:@"Last Ad Showed"];
    [defaults setObject:[NSDate date] forKey:@"Last Ad Showed"];
}
...
- (void)setPreferenceDefaults
{
    ...
    // Set values in the Settings.app programmatically
    //[[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithBool:NO] forKey:@"enabled_preference"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"cloudy" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"cloudy.sqlite"];
